...
!function (a, b) {
  ...
  var c = [],
  ...
  }();var rb = /\r/g;n.fn.extend({ val: function (a) {
      var b,
          c,
          d,
          e = this[0];{
    ...
    n.valHooks[this] = { set: function (a, b) {
      ...
      xb = l.input;n.fn.extend({ attr: function (a, b) {
      ...
      var c,
          d,
          e = 0,
          f = b && b.match(G);if (f && 1 === a.nodeType) while (c = f[e++]) d = n.propFix[c] || c, n.expr.match.bool.test(c) ? xb && wb || !vb.test(c) ? a[d] = !1 : a[n.camelCase("default-" + c)] = a[d] = !1 : n.attr(a, c, ""), a.removeAttribute(wb ? c : d);
    ...
    n.attrHooks[b] = { set: function (a, c) {
      ...
      zb = /^(?:a|area)$/i;n.fn.extend({ prop: function (a, b) {
    ...
    return n.attr(a, "class") || "";
      ...
      var b,
        ...
        b = a.match(G) || [];while (c = this[i++]) if (e = Bb(c), d = 1 === c.nodeType && (" " + e + " ").replace(Ab, " ")) {
      ...
      var b,
          c,
          d = 0;b = " " + a + " ";while (c = this[d++]) if (1 === c.nodeType && (" " + Bb(c) + " ").replace(Ab, " ").indexOf(b) > -1) return !0;return !1;
    ...
    var e,
      ...
      "object" == typeof b && (c = b, b = void 0), c = c || {};var d,
          ...
          var b;if (2 === u) {
            if (!k) {
              k = {};while (b = Ib.exec(g)) k[b[1].toLowerCase()] = b[2];
            }b = k[a.toLowerCase()];
    ...
    });else for (c in a) cc(c, a[c], b, e);return d.join("&").replace(Zb, "+");
    ...
    if (!b.crossDomain || l.cors) {
      var c;return { send: function (d, e) {
          var f,
              g = b.xhr(),
              h = ++dc;if (g.open(b.type, b.url, b.async, b.username, b.password), b.xhrFields) for (f in b.xhrFields) g[f] = b.xhrFields[f];b.mimeType && g.overrideMimeType && g.overrideMimeType(b.mimeType), b.crossDomain || d["X-Requested-With"] || (d["X-Requested-With"] = "XMLHttpRequest");for (f in d) void 0 !== d[f] && g.setRequestHeader(f, d[f] + "");g.send(b.hasContent && b.data || null), c = function (a, d) {
            var f, i, j;if (c && (d || 4 === g.readyState)) if (delete ec[h], c = void 0, g.onreadystatechange = n.noop, d) 4 !== g.readyState && g.abort();else {
    ...
    if (a.crossDomain) {
      ...
      jc = /(=)\?(?=&|$)|\?\?/;n.ajaxSetup({ jsonp: "callback", jsonpCallback: function () {
